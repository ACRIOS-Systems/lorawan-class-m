...
#define DEBUG_MSG(str)              do {if (debug_flags.lbt) fprintf(stderr, str);} while(0)
#define DEBUG_PRINTF(fmt, args...)  do {if (debug_flags.lbt) fprintf(stderr,"%s:%d: "fmt, __FUNCTION__, __LINE__, args);} while(0)
